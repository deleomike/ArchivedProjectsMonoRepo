...
#reflecting a bag of words drawn from a mixture of topics.
#--number of topics determined by poisson distribution
#--topics are drawn from a fixed random distribution
...
#OneVsRestClassifier: known as one versus all strategy
...
plot_subfigure(X, Y, 4, "With unlabeled samples + PCA", "pca")
