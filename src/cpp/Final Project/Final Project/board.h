...
public:
    ...
    void setMartian(string move, std::string searching);
    //Precondition: move
    ...
    void setProtagonist(std::string & character, string move, std::string searching);
    ...
    string next_move(std::string end, std::string begin);
...
private:
    ...
    vector<vector<string>> board = {{"B"," "," ","M"," "},
        {" "," "," "," ", " "},
        {"C"," ", " ", "F","D"},
        {" "," "," "," "," "},
        {" ","T"," ","C"," "}};
