...
def get_concepts(imgurl='https://i.imgur.com/dXQl9xq.jpg?1', threshold=0.8, max_concepts=100):
...
def get_colors(imgurl='https://i.imgur.com/dXQl9xq.jpg?1', threshold=0.1):
